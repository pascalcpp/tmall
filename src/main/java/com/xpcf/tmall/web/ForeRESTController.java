...
import com.xpcf.tmall.comparator.*;
import com.xpcf.tmall.dao.OrderItemDAO;
import com.xpcf.tmall.pojo.*;
import com.xpcf.tmall.service.*;
...
public class ForeRESTController {
    ...
    public Object register(@RequestBody User user){
        ...
        if(exist){
            String message = "your name has been used";
    ...
    public Object category(@PathVariable("cid") Integer cid,String sort){
